...
contract CSAMM {
    ...
    uint256 public reserve0;   // token0代币的存储量

    uint256 public reserve1;   // token1代币的存储量

    uint256 public totalSupply;     // 流动性代币总量

    mapping(address => uint256) public balanceOf;   // 记录每个地址拥有的流动性代币数量 
